...
[comment]: <> ({% pdf "/assets/8BitCPU/8BitCPU_Schematic.pdf" no_link width=100% height=400px %})

&nbsp;

In addition, a PDF of the PCB is available [here][PCB], and is embedded below.

[comment]: <> ({% pdf "/assets/8BitCPU/8BitCPU_PCB.pdf" no_link width=100% height=400px %})
