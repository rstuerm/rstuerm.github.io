...
<object data="{{ site.url }}{{ site.baseurl }}/assets/8BitCPU/8BitCPU_Schematic.pdf" width="100%" height="550px" class="image" type="application/pdf"></object>

&nbsp;

In addition, a PDF of the PCB is available [here][PCB], and is embedded below.

<object data="{{ site.url }}{{ site.baseurl }}/assets/8BitCPU/8BitCPU_PCB.pdf" width="100%" height="550px" class="image" type="application/pdf"></object>
